  ...
  <body class="h-100 p-2" style="background-color: #e4e4e4">
    <div class="row" style="width:100vw;">
        <div class="col-6 pe-4 pt-4 ps-5">
            <h1 class="d-flex justify-content-start" ><b>PENGEMBALIAN MANDIRI</b></h1>
        ...
        <div class="container ps-5 pe-5">
            <div class="card p-3" style="background: #c7c7c7;">
                ...
                <div class="row mb-3 mt-3">
                    ...
                    <div class="col">
                        <div class="d-flex justify-content-end">
                            <form action="">
                                <a class="btn btn-warning me-4" href="/sirkulasi/mandiri/pengembalian/nota">Cetak Bukti Pengembalian</a>
                            </form>
                            <form action="/sirkulasi/mandiri/pengembalian/checkout" method="POST">@csrf
                ...
                <div class="card ps-5 pe-5 pt-2 pb-2" style="background-color:#f0f0f0">
                    <h5 class="d-flex justify-content-center"><b>KERANJANG PENGEMBALIAN</b></h5>
