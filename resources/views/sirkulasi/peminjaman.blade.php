                ...
                <div class="row mb-3 mt-3">
                    ...
                    <div class="col">
                        <div class="d-flex justify-content-end">
                            <form action="">
                                <a class="btn btn-warning me-4" href="/sirkulasi/mandiri/peminjaman/nota">Cetak Bukti Peminjaman</a>
                            </form>
                            <form action="/sirkulasi/mandiri/peminjaman/checkout" method="POST">@csrf
                                <button type="submit" class="btn btn-success">Selesaikan Peminjaman</button>
                            </form>
                        </div>
                    </div>
                </div>
